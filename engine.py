...
def debug_signal(df):
    ...
    print(
        "EMA20:",
        round(df["ema20"].iloc[-1], 2)
    )

    print(
        "EMA50:",
        round(df["ema50"].iloc[-1], 2)
    )

    print(
        "EMA200:",
        round(df["ema200"].iloc[-1], 2)
    )
    ...
    print(
        "RSX:",
        round(df["rsx"].iloc[-1], 2)
    )

    print(
        "WT1:",
        round(df["wt1"].iloc[-1], 2)
    )

    print(
        "WT2:",
        round(df["wt2"].iloc[-1], 2)
    )

    print(
        "VOL RATIO:",
        round(df["vol_ratio"].iloc[-1], 2)
    )
